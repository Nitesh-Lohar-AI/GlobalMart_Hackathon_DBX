...
The 'globalmart_hackathon_dbx_project' project was generated by using the lakeflow-pipelines template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] globalmart_hackathon_dbx_project_etl` to your workspace.
